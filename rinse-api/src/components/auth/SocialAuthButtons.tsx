...
import { startOAuthLogin, type OAuthProvider } from '@/lib/pb-oauth'
...
function AppleIcon() {
  return (
    <svg className="social-auth__icon" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor">
...
export default function SocialAuthButtons({ disabled, onError }: SocialAuthButtonsProps) {
  ...
  return (
    <div className="social-auth">
      ...
      <div className="social-auth__divider">or use email</div>
    </div>
  )
}
