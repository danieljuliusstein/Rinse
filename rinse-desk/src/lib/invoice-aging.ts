...
export function invoiceAgeDays(inv: DeskInvoice, now = new Date()): number {
...
export function agingBucket(inv: DeskInvoice, now = new Date()): AgingBucket {
...
export function summarizeAging(invoices: DeskInvoice[]) {
