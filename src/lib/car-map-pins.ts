...
/**
 * Shipped default pin layout for assets/images/car-top-view.png (front at top).
 * Users can recalibrate in-app; saved positions override these on that device.
 */
...
export type CarMapArea = (typeof CAR_MAP_PINS)[number]['id']
