...
export function FeaturesSection() {
  return <section id="features" className="px-6 py-20 max-w-6xl mx-auto">
    <h1 className="text-4xl font-bold">From your first client to your next paid job.</h1>
    <p className="my-6">Rinse is preparing for iOS launch. These are the workflows being built and tested for your detailing business.</p>
    <div className="grid md:grid-cols-2 gap-6">
      <FMFeatureCard label="Free" heading="Clients and vehicles together" body="Keep contact details, vehicle profiles and notes in one place." graphic={<div className="p-8">Clients → Vehicles → Notes</div>} tier="shipped" />
      <FMFeatureCard label="Free" heading="Schedule your first jobs" body="Up to five scheduled or in-progress jobs. Complete a job to make room for the next one." graphic={<div className="p-8">Tuesday · 9 AM · Full Detail</div>} tier="shipped" />
      <FMFeatureCard label="Free" heading="Send invoices and get paid" body="Share an invoice PDF or payment link. Stripe setup is required for online payments; processing costs apply." graphic={<div className="p-8">Invoice → Customer checkout → Payment</div>} tier="shipped" />
      <FMFeatureCard label="Starter · $6/month" heading="More tools when you need them" body="Unlimited active jobs, booking links, quotes, lead pipeline, inventory, expenses, reports and receipt scan." graphic={<div className="p-8">Organize → Schedule → Track your business</div>} tier="shipped" />
    </div>
    <a href="/#pricing" className="rinse-primary inline-block mt-8">See plans and join the waitlist</a>
  </section>;
}
