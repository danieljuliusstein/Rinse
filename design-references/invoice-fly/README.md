...
| # | Screen / flow | Frame range | Archetypes | Rinse wave |
|---|---------------|-------------|------------|------------|
| 1 | Splash / app logo | 274877 | — | — |
| 2 | Welcome + ATT tracking dialog | 274878–274879 | — | 48 |
| 3 | Onboarding hero carousel (“Invoice in seconds”, “Get paid faster”, “Scan receipts”) | 274880–274883 | `step-enter` | 48 |
| 4 | Business setup — upload logo + progress bar | 274885–274887 | `progress-fill`, `sheet-enter` | 48 |
| 5 | Image picker sheet + photo gallery | 274886–274888 | `sheet-enter`, `sheet-exit` | 41, 48 |
| 6 | Logo upload complete + success badge | 274890 | `success-pop` | 48 |
| 7 | AI estimate builder + confetti | 274892 | `success-pop`, `attention-pulse` | 53 |
| 8 | Rating prompt + App Store dialog | 274893–274895 | `sheet-enter` | 48 |
| 9 | Account created hero | 274896 | `success-pop`, `empty-enter` | 48 |
| 10 | Device mockup promo | 274905 | — | — |
| 11 | New invoice + coachmark tooltip | 274921 | `attention-pulse` | 44, 46 |
| 12 | Invoice preview + duplicate confirm modal | 274937 | `sheet-enter`, `press-depth` | 46 |
...
| 3 | Account created success | 274896 (+ 5 frames) | `success-pop` | Onboarding first-invoice | 48 |
| 4 | Voice/settings picker sheet | 275179 (+ 5 frames) | `sheet-enter` | Settings pickers / `VaulSheet` | 41, 47 |
| 5 | Logo upload progress + complete | 274886–274890 | `progress-fill`, `success-pop` | Onboarding business step | 48 |
...
4. Check `../STYLE_PLAN.md` for which wave implements each flow
