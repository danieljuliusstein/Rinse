...
import { EARLY_PLAN, FREE_PLAN, STARTER_PLAN } from './plans'

export type PricingOffer = 'early' | 'starter'
...
/** Price label for the current upgrade CTA (Early $3 while seats remain). */
