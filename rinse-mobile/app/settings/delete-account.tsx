      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        <Card>
          ...
          <AppText variant="caption" style={styles.hint}>
            Billing is managed at rinsehq.com or Apple — cancel any subscription before deleting. Cancellation returns you to Free and preserves your records; delete permanently removes data.
          </AppText>
        </Card>
